...
// app.js gate(...)) work off the coarser `role` strings that already
// existed (admin / production / accounts / sales / stores). A user's
// `department` drives what they SEE (web nav + route guards); their
// derived `role` drives what the API lets them DO.
//
...
// payroll) were widened to accept `accounts`.
