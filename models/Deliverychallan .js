...
//   Mirrors the same shape used on Order/JobOrder. One entry per
//   DC lifecycle event — created, status updated, deleted.
...
const DeliveryChallanSchema = new mongoose.Schema(
  {
    ...
    // 🪪 Audit timeline — one entry per DC lifecycle event.
    fingerprints: {
